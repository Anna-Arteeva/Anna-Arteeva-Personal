...
const Index = () => {
  return (
    <div className="min-h-screen">
      ...
      <section id="training" className="max-w-6xl mx-auto px-4 pt-20">
        <h2 className="font-playfair font-black text-4xl md:text-5xl text-black dark:text-white mb-12 text-center">
          Build products smarter with AI
        </h2>
        <p className="font-raleway text-gray-800 dark:text-gray-200 text-center text-2xl max-w-5xl mx-auto mb-16">
          Upskill your design and product teams with{" "}
