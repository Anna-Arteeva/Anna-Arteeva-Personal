...
const TrainingTopics = () => {
  ...
  const trainingTitleRef = useRef<HTMLHeadingElement>(null);
  ...
  const getElementOpacity = (elementRef: React.RefObject<HTMLHeadingElement | HTMLDivElement> | HTMLHeadingElement | HTMLDivElement | null) => {
